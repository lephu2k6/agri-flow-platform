...
const Login = () => {
  ...
  const handleDemoLogin = (role) => {
    ...
    toast.info(`Đã điền thông tin demo cho ${roleName}`);
  }
    ...
    <div className="min-h-screen flex bg-gradient-to-br from-emerald-50 via-white to-sky-50">
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12">
        <div className="w-full max-w-md">
          ...
          {/* Demo Accounts */}
          <div className="mb-8">
            <p className="text-sm font-black text-gray-800 mb-3 uppercase tracking-widest italic decoration-emerald-500 underline decoration-2 underline-offset-4">Trải nghiệm nhanh (Demo):</p>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
              <button
                type="button"
                onClick={() => handleDemoLogin('admin')}
                className="px-3 py-2.5 bg-indigo-600 text-white rounded-xl font-bold text-[10px] uppercase tracking-wider hover:bg-indigo-700 transition-all shadow-sm flex items-center justify-center gap-2"
              >
              ...
              <button
                ...
                className="px-3 py-2.5 bg-emerald-600 text-white rounded-xl font-bold text-[10px] uppercase tracking-wider hover:bg-emerald-700 transition-all shadow-sm flex items-center justify-center gap-2"
              >
                <User size={14} /> Farmer
              </button>
              <button
                ...
                className="px-3 py-2.5 bg-sky-600 text-white rounded-xl font-bold text-[10px] uppercase tracking-wider hover:bg-sky-700 transition-all shadow-sm flex items-center justify-center gap-2"
              >
                <User size={14} /> Buyer
              </button>
            </div>
